...
def instruction_provider(ctx) -> str:
    ...
    return agent_instruction(
        ...
        f" Every tool that names a clip also returns a finished markdown"
        f" link - `clip_link`, `clip_links`, or the link already inside"
        f" `display`. Paste those exactly. Never build a clip address"
        f" yourself and never retype the host."
